...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // list
        if ('/testiranje' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'list',);
        }

        // forum_list
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\ForumController::index',  '_route' => 'forum_list',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_forum_list;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'forum_list'));
            }
        ...
        if (0 === strpos($pathinfo, '/reddit')) {
            // new_forum
            if ('/reddit/new' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\ForumController::new',  '_route' => 'new_forum',);
            }

            // forum_show
            if (preg_match('#^/reddit/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
